...
const second = 1000,
    ...
    hour = minute * 60,
    day = hour * 24;
let countDown = new Date('Apr 4, 2024 00:00:00').getTime(),
...
new TypeIt("#teks1", {
    strings: [
        "Izinkan hari ini jadi titik awal yang lebih membahagiakan.",
        "Qalbu yang tenang semoga selalu jadi tempat pulangmu.",
        "Rintik harapan tumbuh subur dalam setiap usahamu.",
        "Ingatlah, kamu pantas untuk semua hal baik di dunia ini.",
        "Menjadi versi terbaikmu adalah hadiah paling indah.",
        "Atas nama kasih, semoga Tuhan selalu menjaga langkahmu."
    ],
    startDelay: 4000,
    speed: 100,
